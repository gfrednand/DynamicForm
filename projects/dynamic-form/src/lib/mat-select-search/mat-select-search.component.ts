 ...
 *         <mat-option>
 *           <app-mat-select-search [formControl]="bankFilterCtrl"></app-mat-select-search>
 *         </mat-option>
  ...
  */
  ...
  ngOnInit() {
    ...
    if (this.matOption) {
      ...
      console.error('<app-mat-select-search> must be placed inside a <mat-option> element');
    }
  ...
  private initMultipleHandling() {
    if (!this.matSelect.ngControl) {
      if (this.matSelect.multiple) {
        ...
        console.error('the mat-select containing app-mat-select-search must have a ngModel or formControl directive when multiple=true');
      }
      return;
    }
